...
evaluation = ShuffleSplit(n_splits = number_of_splits,test_size = test_size, random_state= seed)
model = LogisticRegression(solver = "liblinear")

results = cross_val_score(model, input_array,output_array,cv = evaluation)
